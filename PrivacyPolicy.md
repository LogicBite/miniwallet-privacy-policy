...
If we update this security policy, we will keep a log on this page (https://vex.chat/privacy-policy) of the change history. The privacy policy will be kept in a [public git repository](https://github.com/logicbite/miniwallet-privacy-policy), so every change will be viewable in a diff-like format.
